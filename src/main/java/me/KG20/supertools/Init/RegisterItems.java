...
public class RegisterItems {
    ...
    public static final ItemArmor emeraldHelmet = new ItemArmor(BasisArmorMaterial.emerald, EquipmentSlotType.HEAD, new Item.Properties().group(CreativeTabs.armor));
    public static final ItemArmor emeraldChestplate = new ItemArmor(BasisArmorMaterial.emerald, EquipmentSlotType.CHEST, new Item.Properties().group(CreativeTabs.armor));
