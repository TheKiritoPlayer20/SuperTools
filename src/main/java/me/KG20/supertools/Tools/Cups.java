...
public class Cups extends DiggerItem {
    ...
    public Cups(Tier tier, float attackSpeedIn) {
        super(6, attackSpeedIn, tier, blockTags, new Properties().tab(CreativeTabs.supertools));
    }
