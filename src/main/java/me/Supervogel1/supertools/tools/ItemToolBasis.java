...
public class ItemToolBasis extends Item
{
    ...
    protected EnumToolMaterialBasis toolMaterial;

    protected ItemToolBasis(float attackDamageIn, float attackSpeedIn, EnumToolMaterialBasis materialIn, Set<Block> effectiveBlocksIn)
    {
        ...
        if (this instanceof ItemPickaxeBasis)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof ItemAxeBasis)
        {
            toolClass = "axe";
        }
        else if (this instanceof ItemSpadeBasis)
        {
            toolClass = "shovel";
        }
    }

    protected ItemToolBasis(EnumToolMaterialBasis materialIn, Set<Block> effectiveBlocksIn)
    {
