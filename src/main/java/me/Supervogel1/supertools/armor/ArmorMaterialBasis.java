...
public class ArmorMaterialBasis extends Item
{
    ...
    public static final IBehaviorDispenseItem DISPENSER_BEHAVIOR = new BehaviorDefaultDispenseItem()
    {
        ...
        {
            ItemStack itemstack = ArmorMaterialBasis.dispenseArmor(source, stack);
    ...
    /** The EnumArmorMaterial used for this ArmorMaterialBasis */
    private final ArmorMaterialBasis.EnumArmorMaterialBasis material;
    ...
    public ArmorMaterialBasis(ArmorMaterialBasis.EnumArmorMaterialBasis materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
    {
     ...
     */
    public ArmorMaterialBasis.EnumArmorMaterialBasis getArmorMaterial()
    {
    ...
    {
        if (this.material != ArmorMaterialBasis.EnumArmorMaterialBasis.LEATHER)
        {
            return false;
        }
        else
    ...
    {
        return this.material == ArmorMaterialBasis.EnumArmorMaterialBasis.LEATHER || getColor(stack) != 0x00FFFFFF;
    }

    public enum EnumArmorMaterialBasis
    {
        ...
        EMERALD("emerald", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F);
        ...
        private EnumArmorMaterialBasis(String nameIn, int maxDamageFactorIn, int[] damageReductionAmountArrayIn, int enchantabilityIn, SoundEvent soundEventIn, float toughnessIn)
        {
            this.name = nameIn;
        ...
        {
            return ArmorMaterialBasis.MAX_DAMAGE_ARRAY[armorType.getIndex()] * this.maxDamageFactor;
        }
